...
{
    public sealed partial class ProfileLoadFailedSandBox : ErrorSandBox
    {
        //-------------------------------------------------
        ...
        /// <summary>
        /// the back button element in sandbox.
        /// </summary>
        ...
        internal ProfileLoadFailedSandBox() : base()
        {
            InitializeComponent();
        }
        #endregion
