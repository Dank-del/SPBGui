...
namespace SPB.SandBox.ErrorSandBoxes
{
    partial class ProfileWrongSandBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            //fontAndTextAligns:
            this.TitleElement.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 28));
            this.BodyElement.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 26));
            this.BackButton.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 25));
