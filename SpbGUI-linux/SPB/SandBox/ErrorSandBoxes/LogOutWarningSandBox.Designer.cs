...
{
    partial class LogOutWarningSandBox
    {
        //-------------------------------------------------
        ...
        private void InitializeComponent()
        {
            ...
            //fontAndTextAligns:
            this.TitleElement.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 18));
            this.BodyElement.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 16));
            this.ExitButton.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 15));
            this.RetryButton.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 15));
