...
namespace SPB.SandBox
{
    partial class LoginProfileSandBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            //fontAndTextAligns:
            this.TitleElement.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 22));
            this.BodyElement.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 20));
            this.ExitButton.ChangeFont(FontManager.GetSprite(SPB_Fonts.SPB_tt_regular, 19));
