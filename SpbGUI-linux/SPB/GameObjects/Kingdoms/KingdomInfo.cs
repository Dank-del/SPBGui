...
namespace SPB.GameObjects.Kingdoms
{
    public class KingdomInfo
    {
        ...
        private const string MESSAGE = "Kingdoms -- SPB";
        #endregion
        //-------------------------------------------------
        ...
        /// East    : 4,
        /// Center  : ? (5).
        /// check here: <see cref="SPB_Kingdoms"/>
        /// </summary>
        public uint Index { get; set; }
        public SPB_Kingdoms Provider { get; }
        #endregion
        //-------------------------------------------------
        #region Constructor's Region
        private KingdomInfo(SPB_Kingdoms provider)
        {
            Provider = provider;
        }
        #endregion
        ...
        public ChatChannels GetKingdomChannel()
        {
            switch (Provider)
            {
                case SPB_Kingdoms.North:
                    return ChatChannels.K_1_Chat;
                case SPB_Kingdoms.South:
                    return ChatChannels.K_2_Chat;
                case SPB_Kingdoms.West:
                    return ChatChannels.K_3_Chat;
                case SPB_Kingdoms.East:
                    return ChatChannels.K_4_Chat;
                // case SPB_Kingdoms.Center: not completed yet.
                default:
                    throw new Exception();
            }
        }
        ...
        public static async Task<DataBaseDataChangedInfo> CreateKingdomInfo(SPB_Kingdoms index)
        {
        ...
        {
            return await GetKingdomInfo((SPB_Kingdoms)index);
        }
        public static async Task<KingdomInfo> GetKingdomInfo(SPB_Kingdoms _kingdom_)
        {
        ...
        public static async Task<bool> Delete(SPB_Kingdoms _kingdom_)
        {
