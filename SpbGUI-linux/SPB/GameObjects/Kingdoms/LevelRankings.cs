...
namespace SPB.GameObjects.Kingdoms
{
    public sealed class LevelRankings : Rankings
    {
        ...
        /// </summary>
        public const string LevelRankings_LOC = "レウェローランキング.SPB";
        /// <summary>
        ...
        private const string MESSAGE = "LVL_R -- SPB";
        #endregion
        //-------------------------------------------------
        ...
        public static async Task<bool> DeleteLevelRankings(SPB_Kingdoms _kingdom_)
        {
