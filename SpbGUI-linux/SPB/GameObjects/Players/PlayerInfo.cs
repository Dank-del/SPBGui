...
namespace SPB.GameObjects.Players
{
    public class PlayerInfo
    {
        ...
        public const string MESSAGE         = "SPB -- PlayerInfo";
        #endregion
        //-------------------------------------------------
        ...
        /// </summary>
        public virtual SPB_Kingdoms PlayerKingdom { get; protected set; }
        /// <summary>
        ...
        private void SetParams(StrongString serverValue)
        {
            ...
            PlayerKingdom       = (SPB_Kingdoms)myStrings[16].ToInt32();            // 17
