...
namespace SPB.GameObjects.Players
{
    ...
    public partial class Me : Player
    {
        ...
        public const string ME_MESSAGE      = "ME -- SPB";
        ...
        public async void CreatePlayerInfoWorker(Trigger sender, TickHandlerEventArgs<Trigger> handler)
        {
            ...
            PlayerKingdom       = SPB_Kingdoms.NotSet;                          // 17
        ...
        public void SetPlayerKingdom(SPB_Kingdoms playerKingdom)
        {
