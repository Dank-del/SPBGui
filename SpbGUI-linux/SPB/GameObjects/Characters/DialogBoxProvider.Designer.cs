...
namespace SPB.GameObjects.Characters
{
    partial class DialogBoxProvider
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.DialogLabel.Font = new Font(
                ThereIsConstants.Forming.MainClient.PrivateFonts.Families[1], 19, FontStyle.Bold);
            this.CharacterNameLabel.Font =
                new Font(ThereIsConstants.Forming.MainClient.PrivateFonts.Families[1], 14, FontStyle.Bold);
            ...
            if (IsRightPictureBoxActive)
            {
                this.RightCharacterPicture.Size =
                    new Size(ThereIsConstants.Forming.MainClient.Width / 5,
                    ThereIsConstants.Forming.MainClient.Height / 3);
                this.LeftCharacterPicture.Size =
                    new Size(ThereIsConstants.Forming.MainClient.Width / 6,
                    ThereIsConstants.Forming.MainClient.Height / 4);
            }
            else
            {
                this.LeftCharacterPicture.Size =
            ...
            this.DialogLabel.Location = 
                new Point((ThereIsConstants.Forming.MainClient.Width / 2) -
                (DialogLabel.Width / 2), ThereIsConstants.Forming.MainClient.Height - DialogLabel.Height);
        ...
        public void Owner_Click(object sender, EventArgs e)
        {
            ...
            if(CurrentStepOfDialog + 1 <= (int)CharactersHashTable[CharHashTable_CODE])
            {
                ...
                this.DialogLabel.Size = 
                    new Size(8 * (ThereIsConstants.Forming.MainClient.Width / 10),
                    ThereIsConstants.Forming.MainClient.Height / 4);
                */
                /*
                this.CharacterNameLabel.Size = new Size(ThereIsConstants.Forming.MainClient.Width / 8,
                    ThereIsConstants.Forming.MainClient.Height / 7); */
                if (IsRightPictureBoxActive)
                {
                    this.RightCharacterPicture.Size =
                        new Size(ThereIsConstants.Forming.MainClient.Width / 5,
