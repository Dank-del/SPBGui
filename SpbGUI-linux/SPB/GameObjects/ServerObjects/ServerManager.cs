...
namespace SPB.GameObjects.ServerObjects
{
    internal sealed class ServerManager : IServerManager
    {
        ...
        public const string DEFAULT_MESSAGE                 = "SPB";
        ...
        public IServerProvider<QString, DataBaseClient> Get_Kingdom_Server(SPB_Kingdoms _kingdom_)
        {
            if (_kingdom_ == SPB_Kingdoms.NotSet)
            {
                return ServerInfo.GetInvalid();
            }
