        ...
        public bool Exists(GraphicElements _e)
        {
            ...
            if (_e is SandBoxBase _s)
            {
                ...
                if (_s.IsErrorSandBox())
                {
                    ...
                    {
                        // NOTICE: 
                        // only the Element Manager of the MainClient
            ...
            if (_e is SandBoxBase _s)
            {
                ...
                if (_s.IsErrorSandBox() && _s is ErrorSandBox _err)
                {
                    ...
                    else if (_s.SandBoxPriority == SandBoxPriority.TopMostErrorSandBox)
                    {
                        ...
                        // MainClient (other managers cannot add error sandboxes),
                        ...
                        // NOTICE: in the MainForm (Starting Mode) of the MainClient,
