...
namespace SPB.Client
{
	...
	public sealed class Universe
	{
		...
		/// <summary>
		/// windows manager of the SPB world.
		/// </summary>
		public const string ToStringValue = "UNIVERSE_MANAGER -- SPB";
...
#endif
		public const string DEFAULT_CONFIG_TEXT = "-- SPB UNIVERSE -- V1.0.0";
		...
		/// <summary>
		/// the main window of the MainClient,
		...
		/// the client.
		/// </param>
		public Universe(IntPtr _handle_, MainClient _client_)
		{
			Handle = _handle_;
			Client = _client_;
		...
		/// <summary>
		/// Call this method in <see cref="MainClient.Update(GameTime)"/>.
		/// </summary>
