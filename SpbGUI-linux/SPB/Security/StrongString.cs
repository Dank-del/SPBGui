...
using static SPB.Client.Universe;

namespace SPB.Security
{
#pragma warning disable IDE0032
	public sealed class StrongString : IStringProvider<StrongString>, ISessionData
	{
		...
		public static FontManager Manager
		{
			get 
			{
				if (ThereIsConstants.Forming.MainClient == null)
				{
					return null;
				}
				return ThereIsConstants.Forming.MainClient.FontManager;
			}
		}
		#endregion
		//-------------------------------------------------
		...
		{
			var manager = ThereIsConstants.Forming.MainClient.FontManager;
