...
* Directory names should follow the namespace for the class after `SPB`. For example, one would expect to find the public class `SPB.Constants.WotoTools` in **SPB\Constants\WotoTools.cs**.
...
namespace MyNamespace 
{
	public class MyClass : IFoo 
	{
		...
		/// </summary>
		public static MainClient BigFather
		{
